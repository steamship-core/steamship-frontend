...
These vector databases can be used in a number of ways, but the most common is to combine it with a [question answering tool](/agent-guidebook/question-answering).

...
- [Clone GitHub Project](https://steamship.com/learn/clone-github) - _⭐️ Best for Developers_
- [Use a Dev Container in your Browser](https://steamship.com/learn/clone-devcontainer-browser) - _🎓 Easiest for Classrooms_
- [Use a Dev Container in Docker on Localhost](https://steamship.com/learn/clone-devcontainer-local)

## Git Clone (Local) Setup

<YouTube id="6fYO1hUpyz4" />
